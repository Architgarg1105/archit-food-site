...
?>
<?php
$output="Create your Customer Account!!!";
...
<body>
    ...
    <div class="log-form">
        ...
        <br>
        <button style="float:left;margin-left:75px;margin-top:10px;" disabled>Preference</button>
        ...
        <a class="register" href="CustomerLogin.php">Login</a></p>
        </form>
      </div>
    </center>
</body>
